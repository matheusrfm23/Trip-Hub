...
class Database:
    ...
    def _migrate_file(cls, cursor, table, filename, parser_func):
        """Retorna lista de arquivos processados com sucesso para renomear."""
        ...
        try:
            ...
            # Se falhar, não retorna na lista para renomear, permitindo retry futuro
            return []
    ...
    def _migrate_places(cls, cursor):
        """Busca arquivos padrao {pais}_{cat}.json"""
